class Event < ApplicationRecord
     ...
     def self.sign_in_page(current_member, current_event)
          ...
          # 1800 for 30 minutes to sign in before or after the event starts, 21600 for 6 hour offset that comes with utc time zone
          if current_member && DateTime.now.utc > current_event.date + 19800 && DateTime.now.utc < current_event.date + 23400 
               ...
               puts(current_event.date + 19800)
               puts(current_event.date + 23400)
